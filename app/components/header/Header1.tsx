      ...
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-4">
          {isConnected && isRegistered ? (
            <Link href="/manage-projects" className="bg-white text-green-500 px-11 py-3 rounded-full hover:bg-green-100 transition duration-300 font-semibold shadow-md hover:shadow-lg text-m">
              Manage Projects
            </Link>
          ) : (
